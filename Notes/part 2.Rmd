...
\begin{align}
f(\alpha, \beta, \lambda_1,\dots, \lambda_n | y_1,\dots, y_n) & \propto  f(\alpha,\beta, \lambda_{1:n}, y_{1:n}) = \\ 
...
\begin{align}
\pi(\beta | \alpha, \lambda_{1:n}, y_{1:n}) & = \beta^{-0.9} e^{-\beta} \prod_{i=1}^n \beta^\alpha e^{-\beta \lambda_i} = \\
